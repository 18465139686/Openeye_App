 ...
 */
public class ShareItFragment extends BaseFragment<TimeV, TimeP> implements TimeV {


    @BindView(R.id.time_rlv)
    RecyclerView mTimeRlv;
    private View view;
    ...
    protected void initListener() {
        mTimeRlv.setLayoutManager(new LinearLayoutManager(getContext()));

        adapter = new FindTimeReyclerAdapter(list,getContext());
        mTimeRlv.setAdapter(adapter);
    ...
    protected int getLayoutId() {
        return R.layout.fragment_share_it;
    }
